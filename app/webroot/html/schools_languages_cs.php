...
<html>
    <head>
    	...
    	<title>Escuelas - Idiomas - Ciudad Escogido</title>
    	...
    	<div id="container">
    		...
    		<div id="content" class="page nopadding">
                        ...
                        <div class="info">
                            ...
                            <form class="search_language">
                                ...
                                <select class="destination">
                                    ...
                                    <option value="1" selected="selected">Los Angeles</option>
                ...
                <div class="videos school clear">
                    <div class="inner">
                        <h3>Ofertas cursos Ingl&eacute;s en Los Angeles</h3>
                ...
                <div class="type_course">
                    <div class="inner">
                        <h3>Mejores escuelas de Los Angeles</h3>
                        <ul>
                            <?php for($i=0; $i<8; $i++):?>
                            <li class="<?php echo $i%2 == 0 ? "odd": "pair"?>">
                                <div class="box left">
                ...
                <div class="knows_the_city">
                    <div class="inner">
                        <h3 style="margin-bottom: 20px;">Conoce la ciudad</h3>
                        <ul class="comments3">
                            <li>
                                <a class="title" href="#">Los Angeles</a>
                                ...
                                <a class="more right" href="#">Leer m&aacute;s >></a>
                            </li>
                        </ul>
                    </div>
                </div><!--.knows_the_city-->
