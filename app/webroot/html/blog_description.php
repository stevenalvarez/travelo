                                        ...
                                        <div class="bsocial padding10 bwhite overflow">
                                            <div class="reviews">
                                                ...
                                                <ul class="right">
                                                    ...
                                                    <li class="last">
                                                        <a class="tags" href="#">salud,aventura</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>                                    
                                        ...
                                        <li>
                                            <div class="post">
                                                ...
                                                <div class="right descripcion">
                                                    <h3>
                                                        <span class="colorblue">David Jhon</span>
                                                    </h3>
                                        ...
                                        <form style="padding-top: 0;">
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <label>MENSAJE</label>
                                                        <textarea placeholder="escribe tu mensaje aqu&iacute;"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <input class="btn green" type="submit" value="ENVIAR COMENTARIO" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </form>
